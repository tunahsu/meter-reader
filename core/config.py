...
__C.YOLO.CLASSES              = "./data/classes/analog_ammeter.names"
...
__C.TRAIN.ANNOT_PATH          = "./data/dataset/analog_ammeter_train.txt"
...
__C.TEST.ANNOT_PATH           = "./data/dataset/analog_ammeter_val.txt"
